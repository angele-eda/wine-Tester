(function () {
  ...
  window.CF24_I18N = {
    en: {
      ...
      benefitLocalTitle: "100% private", benefitLocalCopy: "Processed on your device.",
      benefitFastTitle: "No installs", benefitFastCopy: "No installation or sign-up. Start converting instantly.",
      benefitFreeTitle: "Free forever", benefitFreeCopy: "Unlimited tools for desktop and mobile web users.",
      ...
      chooseTitle: "18 tools, one place", chooseCopy: "Simple tools for everyday file work", toolCount: "18 tools available", popular: "Most popular", morePdfTools:"Show more PDF tools", lessPdfTools:"Show fewer PDF tools",
      ...
      imageCropName: "Crop Images", imageCropCopy: "Select and crop the exact area you want from an image.", qrName: "QR Code Generator", qrCopy: "Create a downloadable QR code from a link or text.", organizeName:"Organize PDF", organizeCopy:"Reorder, rotate or remove PDF pages in one simple workspace.", rotatePdfName:"Rotate PDF", rotatePdfCopy:"Rotate individual PDF pages left or right.", deletePdfName:"Delete PDF Pages", deletePdfCopy:"Remove unwanted pages and save a clean PDF.", extractPdfName:"Extract PDF Pages", extractPdfCopy:"Select specific pages and save them as a new PDF.", videoName:"Video Tools", videoCopy:"Convert to MP4, compress videos, or extract MP3 audio locally.",
      ...
      quality: "Quality", imageWidth: "Width", imageHeight: "Height", maintainAspect: "Keep aspect ratio", cropFit: "Fit to screen", cropPan: "Move image", cropHint: "Adjust the crop area, or use Move image to pan. Pinch with two fingers to zoom.", keepNames: "Keep original file names", privateProcessing: "Private processing", privateCopy: "Your files stay on this device.",
      complete: "Processing complete", completeCopy: "Your files are ready. All processing stayed on this device.", download: "Download",
      convertFiles: "Convert files", convertOne: "Convert 1 file", convertMany: "Convert {count} files", cropAction: "Crop image", processing: "Processing locally...", ready: "READY", queued: "QUEUED",
    ...
    ko: {
      ...
      benefitLocalTitle: "100% 개인정보 보호", benefitLocalCopy: "기기에서 처리됩니다.",
      benefitFastTitle: "설치 필요 없음", benefitFastCopy: "설치나 가입 없이 바로 변환할 수 있습니다.",
      benefitFreeTitle: "계속 무료", benefitFreeCopy: "데스크톱과 모바일에서 자유롭게 사용할 수 있습니다.",
      ...
      chooseTitle: "18개 도구를 한곳에서", chooseCopy: "일상적인 파일 작업을 위한 간단한 도구", toolCount: "18개 도구", popular: "가장 인기", morePdfTools:"PDF 도구 더보기", lessPdfTools:"PDF 도구 접기",
      ...
      imageCropName: "이미지 자르기", imageCropCopy: "이미지에서 원하는 영역을 직접 선택해 잘라냅니다.", qrName: "QR 코드 만들기", qrCopy: "링크나 문자를 다운로드 가능한 QR 코드로 만듭니다.", organizeName:"PDF 페이지 정리", organizeCopy:"PDF 페이지 순서 변경, 회전, 삭제를 한 화면에서 처리합니다.", rotatePdfName:"PDF 회전", rotatePdfCopy:"PDF 페이지를 왼쪽 또는 오른쪽으로 회전합니다.", deletePdfName:"PDF 페이지 삭제", deletePdfCopy:"필요 없는 페이지를 삭제하고 PDF로 저장합니다.", extractPdfName:"PDF 페이지 추출", extractPdfCopy:"필요한 페이지만 선택해 새 PDF로 저장합니다.", videoName:"Video Tools", videoCopy:"동영상을 MP4로 변환·압축하거나 MP3 오디오를 추출합니다.",
      ...
      quality: "품질", imageWidth: "가로", imageHeight: "세로", maintainAspect: "가로세로 비율 유지", cropFit: "화면에 맞춤", cropPan: "이미지 이동", cropHint: "자를 영역을 조절하거나 이미지 이동을 사용하세요. 두 손가락으로 확대·축소할 수 있습니다.", keepNames: "원본 파일명 유지", privateProcessing: "안전한 로컬 처리", privateCopy: "파일은 이 기기에서만 처리됩니다.",
      complete: "처리 완료", completeCopy: "파일이 준비되었습니다. 모든 처리는 이 기기에서 완료되었습니다.", download: "다운로드",
      convertFiles: "파일 변환", convertOne: "파일 1개 변환", convertMany: "파일 {count}개 변환", cropAction: "이미지 자르기", processing: "기기에서 처리 중...", ready: "완료", queued: "대기",
    ...
    ja: {
      ...
      benefitLocalTitle: "100% プライベート", benefitLocalCopy: "端末上で処理されます。",
      benefitFastTitle: "インストール不要", benefitFastCopy: "インストールや登録なしですぐに変換できます。",
      benefitFreeTitle: "ずっと無料", benefitFreeCopy: "デスクトップとモバイルで自由に利用できます。",
      ...
      chooseTitle: "18のツールをひとつに", chooseCopy: "日常のファイル作業に使えるシンプルなツール", toolCount: "18個のツール", popular: "人気", morePdfTools:"PDFツールをさらに表示", lessPdfTools:"PDFツールを閉じる",
      ...
      imageCropName: "画像切り抜き", imageCropCopy: "画像から必要な範囲を選択して切り抜きます。", qrName: "QRコード作成", qrCopy: "リンクや文字からダウンロード可能なQRコードを作成します。", organizeName:"PDFページ整理", organizeCopy:"PDFページを並べ替え、回転、削除できます。", rotatePdfName:"PDFを回転", rotatePdfCopy:"PDFページを左右に回転します。", deletePdfName:"PDFページを削除", deletePdfCopy:"不要なページを削除してPDFを保存します。", extractPdfName:"PDFページを抽出", extractPdfCopy:"必要なページを選んで新しいPDFに保存します。", videoName:"Video Tools", videoCopy:"MP4変換、動画圧縮、MP3音声抽出を端末内で行います。",
      ...
      quality: "品質", imageWidth: "幅", imageHeight: "高さ", maintainAspect: "縦横比を維持", cropFit: "画面に合わせる", cropPan: "画像を移動", cropHint: "切り抜き範囲を調整するか、画像移動を使用します。2本指で拡大・縮小できます。", keepNames: "元のファイル名を保持", privateProcessing: "安全なローカル処理", privateCopy: "ファイルはこの端末内だけで処理されます。",
      complete: "処理完了", completeCopy: "ファイルの準備ができました。処理はすべて端末内で完了しました。", download: "ダウンロード",
      convertFiles: "ファイルを変換", convertOne: "1ファイルを変換", convertMany: "{count}ファイルを変換", cropAction: "画像を切り抜く", processing: "端末内で処理中...", ready: "完了", queued: "待機",
    ...
    es: {
      ...
      benefitLocalTitle: "100% privado", benefitLocalCopy: "Se procesa en tu dispositivo.",
      benefitFastTitle: "Sin instalaciones", benefitFastCopy: "Sin instalar ni registrarte. Convierte al instante.",
      benefitFreeTitle: "Gratis para siempre", benefitFreeCopy: "Herramientas disponibles en ordenador y móvil.",
      ...
      chooseTitle: "18 herramientas en un solo lugar", chooseCopy: "Herramientas sencillas para tus archivos", toolCount: "18 herramientas", popular: "Más popular", morePdfTools:"Ver más herramientas PDF", lessPdfTools:"Ocultar herramientas PDF",
      ...
      imageCropName: "Recortar imágenes", imageCropCopy: "Selecciona y recorta exactamente el área que quieras de una imagen.", qrName: "Generador de códigos QR", qrCopy: "Crea un código QR descargable desde un enlace o texto.", organizeName:"Organizar PDF", organizeCopy:"Reordena, gira o elimina páginas PDF en un solo lugar.", rotatePdfName:"Girar PDF", rotatePdfCopy:"Gira páginas PDF individuales a la izquierda o derecha.", deletePdfName:"Eliminar páginas PDF", deletePdfCopy:"Elimina páginas no deseadas y guarda el PDF.", extractPdfName:"Extraer páginas PDF", extractPdfCopy:"Selecciona páginas y guárdalas en un nuevo PDF.", videoName:"Video Tools", videoCopy:"Convierte a MP4, comprime vídeos o extrae audio MP3 localmente.",
      ...
      quality: "Calidad", imageWidth: "Ancho", imageHeight: "Alto", maintainAspect: "Mantener proporción", cropFit: "Ajustar a pantalla", cropPan: "Mover imagen", cropHint: "Ajusta el área de recorte o usa Mover imagen. Pellizca con dos dedos para ampliar.", keepNames: "Conservar nombres originales", privateProcessing: "Procesamiento privado", privateCopy: "Tus archivos permanecen en este dispositivo.",
      ...
      convertFiles: "Convertir archivos", convertOne: "Convertir 1 archivo", convertMany: "Convertir {count} archivos", cropAction: "Recortar imagen", processing: "Procesando localmente...", ready: "LISTO", queued: "EN COLA",
