(function () {
  ...
  window.CF24_I18N = {
    en: {
      ...
      chooseTitle: "14 tools, one place", chooseCopy: "Simple tools for everyday file work", toolCount: "14 tools available", popular: "Most popular",
      ...
      imageCropName: "Crop Images", imageCropCopy: "Select and crop the exact area you want from an image.", qrName: "QR Code Generator", qrCopy: "Create a downloadable QR code from a link or text.", organizeName:"Organize PDF", organizeCopy:"Reorder, rotate or remove PDF pages in one simple workspace.",
    ...
    ko: {
      ...
      chooseTitle: "14개 도구를 한곳에서", chooseCopy: "일상적인 파일 작업을 위한 간단한 도구", toolCount: "14개 도구", popular: "가장 인기",
      ...
      imageCropName: "이미지 자르기", imageCropCopy: "이미지에서 원하는 영역을 직접 선택해 잘라냅니다.", qrName: "QR 코드 만들기", qrCopy: "링크나 문자를 다운로드 가능한 QR 코드로 만듭니다.", organizeName:"PDF 페이지 정리", organizeCopy:"PDF 페이지 순서 변경, 회전, 삭제를 한 화면에서 처리합니다.",
    ...
    ja: {
      ...
      chooseTitle: "14のツールをひとつに", chooseCopy: "日常のファイル作業に使えるシンプルなツール", toolCount: "14個のツール", popular: "人気",
      ...
      imageCropName: "画像切り抜き", imageCropCopy: "画像から必要な範囲を選択して切り抜きます。", qrName: "QRコード作成", qrCopy: "リンクや文字からダウンロード可能なQRコードを作成します。", organizeName:"PDFページ整理", organizeCopy:"PDFページを並べ替え、回転、削除できます。",
    ...
    es: {
      ...
      chooseTitle: "14 herramientas en un solo lugar", chooseCopy: "Herramientas sencillas para tus archivos", toolCount: "14 herramientas", popular: "Más popular",
      ...
      imageCropName: "Recortar imágenes", imageCropCopy: "Selecciona y recorta exactamente el área que quieras de una imagen.", qrName: "Generador de códigos QR", qrCopy: "Crea un código QR descargable desde un enlace o texto.", organizeName:"Organizar PDF", organizeCopy:"Reordena, gira o elimina páginas PDF en un solo lugar.",
